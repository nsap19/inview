  ...
  <div>
    ...
    <div class="result">
      ...
      <div ref="createButton" class="create-button">
        <el-button class="m-1" :icon="Plus" round plain @click="openCreateMeetingDialog = true" size="large" style="background: linear-gradient(140deg, rgba(243, 240, 215, 0.7) 10%, rgba(255, 120, 120, 0.7) 120%), url(https://grainy-gradients.vercel.app/noise.svg); background-color: white; border: none;"
        >방 만들기</el-button>   
